...
import ProjectPage from "../project_page/ProjectPage.svelte"
...
import ProdConfig from "../prod_config/ProdConfig.svelte"
...
let left_components: {name: string, component: any, btn_icon: string, btn_position: 'top' | 'bottom', on_click: () => void | null}[] = [
    ...
    {name: 'settings_page', btn_icon: 'ri-user-add-line', btn_position: 'top', component: SettingsPage, on_click: null},
